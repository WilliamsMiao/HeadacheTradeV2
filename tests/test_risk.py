...
def test_no_stop_means_no_entry_position_size():
    ...
    assert calculate_position_size(config, entry_price=100, stop_price=None, market_state="RISK_ON", script="SCRIPT_A_BOTTOM_TREND_RESUME", account_equity=100000) is None
    assert calculate_position_size(config, entry_price=100, stop_price=101, market_state="RISK_ON", script="SCRIPT_A_BOTTOM_TREND_RESUME", account_equity=100000) is None
...
def test_script_b_uses_lower_risk():
    ...
    a = calculate_position_size(config, 100, 95, "RISK_ON", "SCRIPT_A_BOTTOM_TREND_RESUME", account_equity=100000)
    b = calculate_position_size(config, 100, 95, "RISK_ON", "SCRIPT_B_TOP_INVALIDATION_CONTINUATION", account_equity=100000)
