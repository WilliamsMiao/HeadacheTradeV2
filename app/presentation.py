...
LABELS: dict[str, str] = {
    ...
    "NOT_REVIEWED": "尚未规则审批",
    "REJECTED_BY_RISK": "风险条件暂不允许入场",
    "REJECTED_BY_PRICE": "当前价格不适合入场",
    "REJECTED_BY_MARKET": "市场环境暂不支持新仓",
    "REJECTED_BY_CAPITAL": "当前可用资金不足",
    "REJECTED_BY_DATA": "行情数据暂不完整",
    "REJECTED_BY_RECONCILIATION": "交易对账闸门阻止",
    "RULES_REJECTED_BY_RECONCILIATION": "规则审批因对账拒绝",
    "RECONCILIATION_RUN_FAILED": "交易对账运行失败",
    "NORMAL": "账本正常",
    "DEGRADED": "轻微对账提示",
    "PROTECTIVE": "保护模式",
    "SYNC_FAILED": "同步失败保护",
    ...
    "SUBMITTED": "已提交",
    "SELL_WAITING_RECONCILIATION": "卖出单待对账",
    "FILLED": "已成交",
    ...
    "SIM_ORDER_REMOTE_MISSING": "远端订单待对账",
    "SELL_ORDER_WAITING_RECONCILIATION": "卖出单等待对账",
    "SIM_ORDER_FILLED_INFERRED": "模拟订单推断成交",
    "FILLED_INFERRED": "推断已成交",
    "UNKNOWN_REMOTE_MISSING": "远端订单待对账",
    "RECONCILIATION_ISSUE_OPEN": "对账问题待处理",
    "RECONCILIATION_ISSUE_RESOLVED": "对账问题已恢复",
    "REMOTE_POSITION_WITHOUT_LOCAL": "富途有仓本地无仓",
    "LOCAL_POSITION_MISSING_REMOTE": "本地有仓富途无仓",
    "REMOTE_ORDER_WITHOUT_LOCAL": "远端订单本地缺失",
    "POSITION_QTY_MISMATCH": "持仓数量不一致",
    "POSITION_COST_MISMATCH": "持仓成本不一致",
    "LOCAL_ORDER_MISSING_REMOTE": "本地订单远端缺失",
    "SELL_ORDER_STUCK": "风控卖单疑似卡住",
    "BUY_ORDER_INFERRED_FILLED": "买入订单推断成交",
    "CLOSE_UNVERIFIED": "仓位关闭未验证",
    "ORDER_STATUS_UNKNOWN": "订单状态未知",
    "ACCOUNT_SYNC_FAILED": "账户同步失败",
    "EXIT_ORDER_RETRIED": "退出委托已重试",
    "EXIT_ORDER_RETRY_LIMIT_REACHED": "退出委托达到重试上限",
    "POSITION_OPENED": "模拟持仓已建立",
    "POSITION_CLOSED": "模拟持仓已关闭",
    "LOCAL_STRATEGY": "本地策略开仓",
    "FUTU_DETECTED": "富途账户检测",
    "LOCAL_AND_FUTU_CONFIRMED": "本地记录 + 富途确认",
    "ORPHAN_POSITION_DETECTED": "检测到富途孤立持仓",
    "ORPHAN_POSITION_MATCH_LOW_CONFIDENCE": "持仓低置信未绑定",
    "POSITION_RECONCILED_CLOSED": "富途持仓已结束",
    "POSITION_RECONCILED_CLOSED_UNVERIFIED": "富途持仓未验证关闭",
    "POSITION_RISK_CHECK_FAILED": "持仓风控检查失败",
    "POSITION_EXIT_SKIPPED": "持仓退出暂时跳过",
    "POSITION_EXIT_ORDER_FAILED": "持仓退出委托失败",
    "NO_STRUCTURE": "尚无 60 分钟结构",
    "WAIT_CONFIRM": "等待结构确认",
    "STOP_TOO_WIDE": "止损距离不合格",
    "BATTLE_BUT_NOT_SA": "作战评级未达 S/A",
    "PLAN_BLOCKED": "计划生成受阻",
    "ACTIVE_PLAN": "已有有效计划",
    "DROPPED": "已退出候选池",
    "INFO": "系统记录",
